...
var knownEnvNames = []string{
	...
	"PAYPAL_CLIENT_ID", "PAYPAL_CLIENT_SECRET", "PAYPAL_ENV", "PAYPAL_ENVIRONMENT", "PAYPAL_WEBHOOK_ID",
	"CRYPTO_RPC_URL", "CRYPTO_ASSET", "CRYPTO_WEBHOOK_SECRET", "CRYPTO_TOKEN_MINT", "CRYPTO_TOKEN_CONTRACT",
	"CRYPTO_RECEIVER", "SOLANA_RECEIVER_ADDRESS", "MRG_SOLANA_PROGRAM_ID",
	"GEMINI_API_KEYS", "OPENAI_API_KEYS", "ANTHROPIC_API_KEYS", "GROQ_API_KEYS", "OPENROUTER_API_KEYS",
	"DEEPSEEK_API_KEYS", "MISTRAL_API_KEYS",
}
