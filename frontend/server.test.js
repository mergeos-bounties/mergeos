...
test('public home keeps a short decision-screen rhythm', async () => {
  ...
  assert.match(appSource, /Fund software work\. Route it\. Prove it\./);
  ...
  assert.match(appSource, /MergeOS turns a brief or repo into funded tasks with CEO-agent planning, builder or AI routing, escrow, PR\/deploy checks, Solana MRG accounting, and public ledger proof\./);
