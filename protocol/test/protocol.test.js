    ...
    candidates: [
      {
        ...
        intent_source: 'marketplace_project',
        ...
        decision_options: [
          {
            ...
            label: 'Approve memo',
            tone: 'approve',
            proof_policy: 'Proceed with airdrop and presale only after escrow, task, and ledger proof are attached.',
            risk_notes: 'Strong source signal with active work pool and accepted delivery evidence.',
          },
          {
            key: 'needs_evidence',
            label: 'Needs evidence',
            tone: 'evidence',
            proof_policy: 'Request source link, accepted task proof, payout log, and Solana token readiness before launch.',
            risk_notes: 'Use when the CEO agent needs more proof before approving token workflow.',
          },
          {
            key: 'reject',
            label: 'Reject',
            tone: 'reject',
            proof_policy: 'Do not open token workflow until the project has verifiable marketplace and ledger evidence.',
        ...
        readiness_gates: [
          {
            ...
            label: 'Demand',
            state: 'ready',
            value: '4 open / 14 accepted',
            evidence: 'marketplace_project, open_bounty_demand, repository_context',
          },
          {
            key: 'proof',
            label: 'Proof',
            state: 'ready',
            value: '3 signals attached',
            evidence: 'marketplace_project, open_bounty_demand, repository_context',
          },
          {
            key: 'anti_bot',
            label: 'Anti-bot',
            state: 'review',
            value: 'Needs wallet review',
            evidence: 'CEO must confirm wallet uniqueness and claim limits before opening.',
          },
        ],
  ...
  const feed = {
    ...
    items: [
      ...
      },
      {
        ...
        body: 'Customer portal rebuild deployment gate is 60% complete across QA, handoff, and release checks.',
        project_id: 'prj_0001',
        project_title: 'Customer portal rebuild',
        actor: 'mergeos-orchestrator',
        reference: 'project:prj_0001',
        url: '/api/public/projects/prj_0001/deployment',
        context_urls: [
          '/api/public/projects/prj_0001/deployment',
          '/api/public/projects/prj_0001/workflow',
          '/api/public/ledger/proof',
        ],
        evidence: ['deployment_status:validating', 'deployment_progress:60', 'ledger_proof:/api/public/ledger/proof'],
        runbook: ['Open deployment proof.', 'Check workflow stage readiness.', 'Verify ledger proof before release.'],
        status: 'validating',
        created_at: now,
      },
      {
      ...
      {
        id: 'agent-lease:agl_0001',
        type: 'agent_lease',
        title: 'QA Agent refreshed lease heartbeat',
        body: 'QA Agent refreshed lease heartbeat for public bounty prj_0001:12.',
        actor: 'QA Agent',
        action: 'heartbeat',
        reference: 'agent_lease:agl_0001;claim:prj_0001:12',
        status: 'heartbeat',
        context_urls: [
          '/api/public/protocol/tasks?task_id=prj_0001:12',
          '/api/public/protocol/agent-queue',
        ],
        evidence: ['claim_id:prj_0001:12', 'lease_id:agl_0001'],
        runbook: ['Fetch task protocol', 'Refresh lease before TTL', 'Attach heartbeat evidence'],
        source_finding_id: 'prj_0001:12',
        signal: 'agent_lease_heartbeat',
        ...
        routing: {
          ...
          routing_packet: {
            ...
            output_contracts: [
              ...
              { action: 'review', artifact_kind: 'pr_review', output_endpoint: '/api/projects/prj_0001/agent-actions', output_protocol: 'mergeos.agent-action.v1', output_protocol_url: '/protocol/agent-action.v1.schema.json', public_url: '/api/public/projects/prj_0001/pull-requests' },
              { action: 'test', artifact_kind: 'test_evidence', output_endpoint: '/api/projects/prj_0001/agent-actions', output_protocol: 'mergeos.agent-action.v1', output_protocol_url: '/protocol/agent-action.v1.schema.json', public_url: '/api/public/projects/prj_0001/ai-workflow' },
              { action: 'generate', artifact_kind: 'generated_work', output_endpoint: '/api/projects/prj_0001/agent-actions', output_protocol: 'mergeos.agent-action.v1', output_protocol_url: '/protocol/agent-action.v1.schema.json', public_url: '/api/public/projects/prj_0001/workflow' },
              { action: 'submit', artifact_kind: 'task_submission', output_endpoint: '/api/tasks/prj_0001:12/submit', output_protocol: 'mergeos.task-submission.v1', output_protocol_url: '/protocol/task-submission.v1.schema.json', public_url: '/api/public/protocol/tasks?task_id=prj_0001:12' },
            ],
          },
        },
      },
          ...
          output_contracts: [
            {
              ...
              public_url: '/api/public/projects/prj_0001/ai-workflow',
            },
            {
              action: 'submit',
        ...
        routing_packet: {
          ...
          output_contracts: [
            ...
            },
            {
              ...
              output_protocol: 'mergeos.agent-action.v1',
              output_protocol_url: '/protocol/agent-action.v1.schema.json',
              public_url: '/api/public/projects/prj_0001/pull-requests',
            },
            {
              action: 'test',
              artifact_kind: 'test_evidence',
...
test('validates deployment protocol documents', () => {
  ...
  const deployment = {
    ...
    validation_packet: {
      ...
      method: 'POST',
      validation_endpoint: '/api/projects/prj_0001/agent-actions',
      target_stage: {
      ...
      context_urls: {
        deployment: '/api/projects/prj_0001/deployment',
      ...
      payload: {
        action: 'deploy',
        bounty_id: 'prj_0001:13',
        agent_type: 'deployment-agent',
        delegated_by: 'ceo-strategy-agent',
        subagent_type: 'deployment-agent',
        status: 'processed',
        reference_url: 'https://github.com/mergeos-bounties/mergeos/issues/13',
        labels: ['deployment: verified'],
        context_urls: ['/api/projects/prj_0001/deployment', '/api/projects/prj_0001/payouts'],
        evidence: ['deployment_handoff', 'release_gate', 'preview_health'],
        runbook: ['Check deployment handoff stage and preview evidence.'],
        checks: [{ name: 'deployment_handoff', status: 'complete', summary: 'Deployment pipeline and handoff notes have been accepted.' }],
    ...
    tasks: [
      {
        ...
        review_packet: {
          status: 'ready',
          method: 'POST',
          review_endpoint: '/api/projects/prj_0001/agent-actions',
          pull_request: {
            number: 151,
            title: 'Fix checkout UI',
            url: 'https://github.com/mergeos-bounties/mergeos/pull/151',
          ...
          runbook: [
            { step: 1, action: 'inspect_pr', label: 'Inspect pull request readiness', endpoint: '/api/projects/prj_0001/pull-requests' },
            { step: 2, action: 'verify_deployment', label: 'Check deployment validation gates', endpoint: '/api/projects/prj_0001/deployment' },
            { step: 3, action: 'record_review', label: 'Record review evidence', endpoint: '/api/projects/prj_0001/agent-actions' },
          ],
          payload: {
            action: 'review',
            claim_id: 'tsk_0001',
            ...
            status: 'processed',
            pull_number: 151,
            reference_url: 'https://github.com/mergeos-bounties/mergeos/pull/151',
            labels: ['evidence: provided', 'star: verified'],
            context_urls: ['/api/projects/prj_0001/pull-requests'],
            evidence: ['evidence: provided', 'star: verified'],
            runbook: ['Verify PR links to the funded bounty issue.'],
            checks: [{ name: 'readiness', status: 'ready', summary: 'PR readiness gate' }],
    ...
    items: [
      ...
      },
      {
        ...
        actions: [
          ...
          { id: 'refresh-queue', label: 'Refresh Queue', type: 'refresh_admin_ops', method: 'GET', endpoint: '/api/admin/ops-queue' },
        ],
        created_at: now,
      },
      {
        ...
        status: 'expired',
        actions: [{ id: 'run-ssl-review', label: 'Run SSL Review', type: 'run_ssl_review', method: 'POST', endpoint: '/api/admin/ssl/review', payload: { domain: 'expired.mergeos.local' } }],
        created_at: now,
      },
      {
...
test('validates event protocol documents and assertion helper', () => {
  ...
  assert.equal(validateProtocolDocument({ ...event, type: 'task.paid' }).valid, true);
